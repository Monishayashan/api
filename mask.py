...
# In[139]:
net = cv2.dnn.readNet("C://intern//obj\opencv_proj//uploads//yolov3.weights", "C://intern//obj//opencv_proj//uploads//yolov3.cfg")
# In[140]:
classes = []
# In[141]:
with open("C://intern//obj//opencv_proj//uploads//coco.names", "r") as f:
